    ...
    return (
        <section className="py-16">
            <div className="container mx-auto  md:flex md:items-center">
                {/* Text Section */}
                <div className="md:w-1/2 lg:p-0 lg:m-0 md:p-0 md:m-0">
                    <div className='lg:w-[592px] md:w-[592px] md:h-[291px] lg:h-[291px]'>
                    ...
                    <p className="text-lg text-[#474747]  mb-2 lg:w-[454px] lg:h-[112px] md:h-[112px]">
                ...
                <div className="md:mt-[-240px] lg:mt-[-240px] ">
                    <img
                        src="/person.png"
                        alt="image"
                        className="lg:w-[9000px] w-[100%] md:w-[9000px] lg:h-[600px] md:h-[600px] sm:rounded-lg"
                    />
                </div>
            </div>
        </section>
